...
# Reference for above: https://github.com/sourcethemes/academic-scripts/blob/master/refactor-pages-to-page-bundles.sh.
# Reference for below: https://www.cyberciti.biz/tips/linux-unix-pause-command.html.
function pause(){
   read -p "$*"
}
