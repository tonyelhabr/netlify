...
# .dir_png <- here::here()
.dir_png <- .dir_proj
export_png <- function(x, dir = .dir_proj, file = deparse(substitute(x)), width = 8, height = 8, ...) {
...
```{r appendix-viz-c-diamonds-export}
...
viz_cor_by_engine <-
  ...
  labs(
    ...
    subtitle = 'Averaged Over <span style = "color:#E15759"><b>diamonds</b></span> and <span style = "color:#B07AA1"><b>mpg</b></span> Data',
    x = NULL, 
    y = NULL
  )
viz_cor_by_engine
