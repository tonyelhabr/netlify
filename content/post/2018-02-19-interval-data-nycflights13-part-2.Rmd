...
header:
  caption: ""
  image: "interval-data-nycflights13-part-2/datetimes-arithmetic.png"
  preview: true
params:
  eval: false
---
...
I'll use the `{nycflight13}` package; however, in order to demonstrate
...
```{r nycflights_tables, eval = FALSE, echo = FALSE}
...
With the setup ret of the way, we can start to look at my approach
